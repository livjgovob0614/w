...
listf = open("/home/donghoon/ssd/jg/disasm/input/FandLP/error_FsubAndLP_for_dnfn.list", "w")
#listf = open("test", "w")
elsef = open("/home/jg/kby/disasm/postproc/20.08~/error_LP_elseCase.list", "w")
test = False
